			...
			<div class="add_right border_a">
				<table class="table">
					...
					<tr class="table-active">
						...
						<td>
							<div class="check_ent displayflex">
								<input type="checkbox" class="chk" name="helperRide" id="ride01"
									value="1" onclick="checkOnlyOne(this)"><label
									for="ride01">자동차</label> <input type="checkbox" class="chk"
									name="helperRide" id="ride02" value="2"
									onclick="checkOnlyOne(this)"><label for="ride02">오토바이</label>
								<input type="checkbox" class="chk" name="helperRide" id="ride03"
									value="3" onclick="checkOnlyOne(this)"><label
									for="ride03">전동퀵보드</label> <input type="checkbox" class="chk"
									name="helperRide" id="ride04" value="4"
									onclick="checkOnlyOne(this)"><label for="ride04">자전거</label>
								<input type="checkbox" class="chk" name="helperRide" id="ride05"
